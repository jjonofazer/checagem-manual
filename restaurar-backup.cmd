...
echo.
echo   1. Descriptografar backup mais recente (gera .sql)
echo   2. Descriptografar um backup especifico (gera .sql)
...
if "%OPCAO%"=="1" goto recente_descriptografar
if "%OPCAO%"=="2" goto descriptografar
...
:recente_descriptografar
call :achar_mais_recente
if "%ARQ%"=="" (
  echo Nenhum backup encontrado em %BACKUPDIR%.
  pause
  goto menu
)
echo Descriptografando: %ARQ%
cd /d "%BACKEND%"
